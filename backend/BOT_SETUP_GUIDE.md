...
3. **Ottieni Credenziali**
   ...
   Webhook URL: https://rebot-tarquinia.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
```
URL: https://rebot-tarquinia.preview.emergentagent.com/api/whatsapp/webhook
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://rebot-tarquinia.preview.emergentagent.com/api/stats/bot-insights
```
