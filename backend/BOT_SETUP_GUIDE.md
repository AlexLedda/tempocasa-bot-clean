...
3. **Ottieni Credenziali**
   ...
   Webhook URL: https://proptech-suite-8.preview.emergentagent.com/api/whatsapp/webhook
   ```
...
```
URL: https://proptech-suite-8.preview.emergentagent.com/api/whatsapp/webhook
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://proptech-suite-8.preview.emergentagent.com/api/stats/bot-insights
```
